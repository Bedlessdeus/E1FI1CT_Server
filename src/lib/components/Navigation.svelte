...
<nav class="bg-bg-primary dark:bg-bg-secondary-dark border-r border-gray-200 dark:border-gray-700 w-64 fixed h-full z-20">
	<div class="p-4">
		
		<div class="mb-8">
			<h1 class="text-2xl font-bold text-text-primary dark:text-text-primary-dark">Twated</h1>
		</div>
